...
add bootstrap for straight.el, was needed to get some packages from GitHub, not needed now
# #+begin_src emacs-lisp
...
There are three choices for running the Julia command line.
    ...
    (setq mu4e-contexts
          (list
           ...
           (make-mu4e-context
            ...
            :vars '((user-mail-address . "gebbie@gmail.edu")
                    (user-full-name    . "Jake")
           ...
           (make-mu4e-context
            ...
            (lambda (msg)
              (when msg
                (string-prefix-p "/jgebbie" (mu4e-message-field msg :maildir))))
           ...
           (make-mu4e-context
            ...
            (lambda (msg)
              (when msg
                (string-prefix-p "/ggebbie" (mu4e-message-field msg :maildir))))
            :vars '((user-mail-address . "ggebbie@whoi.edu")
                    (user-full-name    . "G Jake Gebbie")
                    (smtpmail-smtp-server  . "smtp.gmail.com")
                    (smtpmail-smtp-service . 465)
                    (smtpmail-stream-type  . ssl)
                    (mu4e-drafts-folder  . "/Gmail/[Gmail]/Drafts")
